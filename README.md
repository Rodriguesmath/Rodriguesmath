<img width=100% src="https://capsule-render.vercel.app/api?type=waving&color=1F2228&height=120&section=header"/>

<div align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.herokuapp.com?font=Press+Start+2P&size=40&center=true&vCenter=true&width=1000&height=100&color=FFFFFF&lines=%3CRodriguesmath%2F%3E" alt="Animação de Digitação"/>
  </a>
</div>
...
```json
{
  "nome": "Rodrigues Matheus",
  "formacao": {
    "curso": "Engenharia de Computação",
    "instituicao": "Instituto Federal da Paraíba (IFPB)"
  },
  "status_profissional": "atuando como pesquisador no LAPLIN-IFPB",
...
```json
{
  "hard_skills": {
    ...
    "aprendendo_ativamente": [
      "TypeScript"
      "HTML",
      "CSS"
    ],
    "ferramentas_e_sistemas": [
      "Git",
      "GitHub",
      "Docker",
      "Linux"
